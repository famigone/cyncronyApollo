  ...
  render() {
    if (!this.props.isLoading) {
      ...
      let display = fileCursors.map((aFile, key) => {
        ...
        let link = Filetes.findOne({_id: aFile._id}).link();  //The "view/download" link
      ...
      return <div>
        <div className="row">
          <div className="col-md-12">
            ...
            <input type="file" id="fi leinput" disabled={this.state.inProgress} ref="fileinput"
...
export default FileUploadComponentContainer = withTracker(({} ) => {            
      var handle = Meteor.subscribe('files.all');
